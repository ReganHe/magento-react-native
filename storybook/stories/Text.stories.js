...
storiesOf('Text', module)
  ...
  .add('heading with bold', () => (
    <Text type="heading" bold>
      Hello I am a heading bold text!
    </Text>
  ))
  .add('subHeading', () => (
  ...
  .add('subHeading with bold', () => (
    <Text type="subheading" bold>
      Hello I am a subHeading bold text!
    </Text>
  ))
  .add('body', () => <Text type="body">Hello I am a body text!</Text>)
  .add('body with bold', () => (
    <Text type="body" bold>
      Hello I am a body bold text!
    </Text>
  ))
  .add('label', () => <Text type="label">Hello I am a label text!</Text>)
  .add('label with bold', () => (
    <Text type="label" bold>
      Hello I am a label bold text!
    </Text>
  ))
  .add('caption', () => <Text type="caption">Hello I am a caption text!</Text>)
  .add('caption with bold', () => (
    <Text type="caption" bold>
      Hello I am a caption bold text!
    </Text>
  ))
